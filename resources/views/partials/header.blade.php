                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                src="{{ (!empty(request()->user()->profile_image))? url('upload/admin_images/'.request()->user()->profile_image):url('upload/no_image.jpg') }}"
                                    alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{route('profile.password')}}"><i class="ri-wallet-2-line align-middle me-1"></i> Change Password</a>
